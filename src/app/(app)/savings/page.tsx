    ...
    <div className="mx-auto max-w-5xl space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      {goals.length === 0 ? (
        <Card className="p-10 text-center">
          <PiggyBank className="mx-auto size-10 text-muted" />
          <p className="mt-4 font-semibold">No savings goals yet</p>
          <p className="mt-1 text-sm text-muted">Create your first goal to start tracking progress towards it.</p>
          <Button className="mt-6"><Plus /> Create a goal</Button>
        </Card>
      ) : (
